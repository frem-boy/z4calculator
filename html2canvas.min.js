                    ...
                    Ae(A).forEach(function (A, e) {
                        ...
                        18 === A.type &&
                            ("from" === A.name
                                ...
                                : "color-stop" !== A.name || (2 === (A = A.values.filter($A)).length && ((t = ue(r, A[1])), (A = A[0]), ZA(A) && B.push({ stop: { type: 16, number: 100 * A.number, flags: A.flags }, color: t }))));
                    }),
                    ...
                    : XB(B) &&
                      (rn(B) && B.assignedNodes
                          ...
                          : (n = VB(e, B)).styles.isVisible() &&
                            (RB(B, n, r) ? (n.flags |= 4) : NB(n.styles) && (n.flags |= 2), -1 !== GB.indexOf(B.tagName) && (n.flags |= 8), t.elements.push(n), B.slot, B.shadowRoot ? OB(e, B.shadowRoot, n, r) : en(B) || qB(B) || tn(B) || OB(e, B, n, r)));
            }
        },
        VB = function (A, e) {
                                        ...
                                        return (
                                            ...
                                            s &&
                                                ...
                                                !/(iPad|iPhone|iPod)/g.test(navigator.userAgent) ||
                                                    ...
                                                    (this.context.logger.warn("Unable to restore scroll position for cloned document"), (this.context.windowBounds = this.context.windowBounds.add(s.scrollX - r.left, s.scrollY - r.top, 0, 0)))),
                        ...
                        s &&
                            (!this.options.allowTaint && n
                                ...
                                : (!(r = null !== (A = e.getContext("webgl2")) && void 0 !== A ? A : e.getContext("webgl")) ||
                                      (!1 === (null == (B = r.getContextAttributes()) ? void 0 : B.preserveDrawingBuffer) && this.context.logger.warn("Unable to clone WebGL context as it has preserveDrawingBuffer=false", e)),
                                  s.drawImage(e, 0, 0))),
                        t
                    );
                } catch (A) {
            ...
            ((gs.prototype.getEffects = function (e) {
                for (var A = -1 === [2, 3].indexOf(this.container.styles.position), t = this.parent, r = this.effects.slice(0); t; ) {
                    ...
                    A || 0 !== t.container.styles.position || !t.parent
                        ? (r.unshift.apply(r, s), (A = -1 === [2, 3].indexOf(t.container.styles.position)), 0 !== t.container.styles.overflowX && ((B = ts(t.curves)), (n = rs(t.curves)), ns(B, n) || r.unshift(new is(n, 6))))
                        : r.unshift.apply(r, s),
                        (t = t.parent);
                }
    ...
    function gs(A, e) {
        ...
        (this.container = A),
            ...
            null !== this.container.styles.transform &&
                ((e = this.container.bounds.left + this.container.styles.transformOrigin[0].number), (t = this.container.bounds.top + this.container.styles.transformOrigin[1].number), (r = this.container.styles.transform), this.effects.push(new os(e, t, r))),
                                    ...
                                    switch (A) {
                                        ...
                                        case 1:
                                            Q.webkitTextStrokeWidth &&
                                                t.text.trim().length &&
                                                ((o.ctx.strokeStyle = ie(Q.webkitTextStrokeColor)), (o.ctx.lineWidth = Q.webkitTextStrokeWidth), (o.ctx.lineJoin = window.chrome ? "miter" : "round"), o.ctx.strokeText(t.text, t.bounds.left, t.bounds.top + B)),
                                                (o.ctx.strokeStyle = ""),
                                                (o.ctx.lineWidth = 0),
                                ...
                                if (
                                    (e instanceof pB &&
                                        ...
                                        e.type === hB
                                            ...
                                            : e.type === dB &&
                                              e.checked &&
                                              (this.ctx.save(), this.ctx.beginPath(), this.ctx.arc(e.bounds.left + i / 2, e.bounds.top + i / 2, i / 4, 0, 2 * Math.PI, !0), (this.ctx.fillStyle = ie(HB)), this.ctx.fill(), this.ctx.restore())),
                                    xs(e) && e.value.length)
                                ) {
                                    switch (
                                    ...
                                    (e = function (e) {
                                        ...
                                        return H(this, function (A) {
                                            switch (A.label) {
                                                ...
                                                case 4:
                                                    return (
                                                        t && ((B = Cs(f, h, [t.width, t.height, t.width / t.height])), (o = B[0]), (g = B[1]), (w = B[2]), (c = B[3]), (a = B[4]), (s = d.ctx.createPattern(d.resizeImage(t, c, a), "repeat")), d.renderRepeat(o, s, g, w)),
                                                        [3, 6]
                                                    );
                                                case 5:
                                                    1 === e.type
                                                              ...
                                                              switch (A.size) {
                                                                  ...
                                                                  case 2:
                                                                      0 === A.shape
                                                                          ...
                                                                          : 1 === A.shape && ((n = Math.min(Math.abs(t), Math.abs(t - B)) / Math.min(Math.abs(e), Math.abs(e - r))), (o = (s = ye(r, B, e, t, !0))[0]), (i = s[1]), (c = n * (Q = Ie(o - e, (i - t) / n))));
                                                                      break;
                                                                  case 1:
                                                                      0 === A.shape
                                                                  ...
                                                                  case 3:
                                                                      0 === A.shape
                                                                          ...
                                                                          : 1 === A.shape && ((n = Math.max(Math.abs(t), Math.abs(t - B)) / Math.max(Math.abs(e), Math.abs(e - r))), (o = (s = ye(r, B, e, t, !1))[0]), (i = s[1]), (c = n * (Q = Ie(o - e, (i - t) / n))));
                                                              }
                ...
                return a(this, void 0, void 0, function () {
                    return H(this, function (A) {
                        switch (A.label) {
                            case 0:
                                return (
                                    this.options.backgroundColor && ((this.ctx.fillStyle = ie(this.options.backgroundColor)), this.ctx.fillRect(this.options.x, this.options.y, this.options.width, this.options.height)),
                                    (t = new as((e = B), null)),
                                    (r = new cs(t)),
                                    hs(t, r, r, (e = [])),
                                    ds(t.container, e),
